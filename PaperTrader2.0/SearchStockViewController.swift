...
class SearchViewController: UIViewController {
    ...
    func stocksURL(searchText: String) -> URL {
        ...
        let urlString = String(format: "https://financialmodelingprep.com/api/v3/search?query=%@"+"&limit=10&exchange=NASDAQ,NYSE&apikey=d6d32343ce4ed4d79945c94ca7c9c383", encodedText)
